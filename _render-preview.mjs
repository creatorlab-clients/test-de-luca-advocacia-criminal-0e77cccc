...
// Fallback frameBaseUrl for preview (blob URL populated after upload)
if (!ctx.frameBaseUrl) {
  ctx.frameBaseUrl = 'https://8ispuxmgjxgu2r5q.public.blob.vercel-storage.com/templates/legale-003/frames/';
}
...
console.log('Preview generata: template-legale-003/index-preview.html');
